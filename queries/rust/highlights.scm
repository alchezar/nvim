...
((token_tree (identifier) @type.enum . "::" . (identifier) @_v)
 (#match? @type.enum "^[A-Z]") (#match? @_v "^[A-Z]") (#set! priority 200))
...
((token_tree (identifier) @_e . "::" . (identifier) @type.variant)
 (#match? @_e "^[A-Z]") (#match? @type.variant "^[A-Z]") (#set! priority 200))
...
((token_tree (identifier) @_m . "::" . (identifier) @function.call)
 (#match? @_m "^[a-z]") (#match? @function.call "^[a-z]") (#set! priority 199))
...
((token_tree (identifier) @_t . "::" . (identifier) @function.call)
 (#match? @_t "^[A-Z]") (#match? @function.call "^[a-z]") (#set! priority 199))
...
((token_tree (identifier) @type.variant)
 (#any-of? @type.variant "Ok" "Err" "Some" "None") (#set! priority 201))
...
((token_tree (identifier) @macro . "!") (#set! priority 202))
((token_repetition (identifier) @macro . "!") (#set! priority 202))
